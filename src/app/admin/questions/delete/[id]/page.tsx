...
export default async function DeleteQuestionPage(
  ...
  props: DeleteQuestionParams | any
  ...
  try {
    ...
    return <DeleteQuestionContent />;
  } catch (error) {
    console.error('Error in Delete Question Page:', error);
    return (
      <div className="error-state">
        <h1>Error Loading Question</h1>
        <p>There was an error loading the question data.</p>
        <Link href="/admin/questions" className="action-button">
          Back to Questions
        </Link>
      </div>
